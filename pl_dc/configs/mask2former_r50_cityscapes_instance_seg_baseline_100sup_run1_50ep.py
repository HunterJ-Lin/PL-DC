...
from .data.cityscapes_instance_seg_baseline_100sup_run1 import dataloader
...
train.output_dir = "./output/pl_dc/configs/mask2former_r50_cityscapes_instance_seg_baseline_100sup_run1_50ep"
