...
dataloader.train = L(build_detection_semisup_train_loader)(
    dataset_label=L(get_detection_dataset_dicts)(names="cityscapes_fine_instance_seg_train_30sup"),
    dataset_unlabel=L(get_detection_dataset_dicts)(names="cityscapes_fine_instance_seg_train_30sup-unlabel"),
