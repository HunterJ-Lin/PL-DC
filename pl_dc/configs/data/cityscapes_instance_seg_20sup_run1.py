...
from pl_dc.data.dataset_mapper import DatasetMapperTwoCrop

dataloader = OmegaConf.create()

dataloader.train = L(build_detection_semisup_train_loader)(
    dataset_label=L(get_detection_dataset_dicts)(names="cityscapes_fine_instance_seg_train_20sup"),
    dataset_unlabel=L(get_detection_dataset_dicts)(names="cityscapes_fine_instance_seg_train_20sup-unlabel"),
    mapper_label=L(DatasetMapperTwoCrop)(
    ...
    mapper_unlabel=L(DatasetMapperTwoCrop)(
        augmentation=L(build_transform_gen)(
            min_size_train=[int(x * 0.1 * 1024) for x in range(5, 21)],
            max_size_train=4096,
            min_size_train_sampling="choice",
    ...
    total_batch_size_label=8,
    total_batch_size_unlabel=8,
    num_workers=4,
)
