...
from .data.cityscapes_instance_seg_30sup_run1 import dataloader

from fvcore.common.param_scheduler import MultiStepParamScheduler
from detectron2.config import LazyCall as L
from detectron2.solver import WarmupParamScheduler

model_teacher.sem_seg_head.num_classes = 8
model_student.sem_seg_head.num_classes = 8
...
train.output_dir = "./output/pl_dc/configs/mask2former_r50_cityscapes_instance_seg_30sup_run1_50ep"
